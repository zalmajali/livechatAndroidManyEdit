...
@NgModule({
  ...
  declarations: [AppComponent,PopovercontentComponent,VersionComponent,FastresponseComponent,SubmenuComponent,TemplateComponent],
  ...
  providers: [{ provide: RouteReuseStrategy, useClass: IonicRouteStrategy },Globalization,AppVersion,FirebaseMessaging,Camera,Network,Chooser,Device,FileTransfer,FilePath,AndroidPermissions,StatusBar,SQLite,File,BackgroundMode],
